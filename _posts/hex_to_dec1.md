...
- 整数（符号有り or 無し）と、浮動小数点（IEEE754）の両方の変換に対応したアプリが非常に少ない
- 広告が気に障る
- 機能がいまいち
- デザインがいまいち


特に、整数と浮動小数点の両方に対応している、というのが私的にはマスト！なのだが、ウェブアプリだと、こういうのしかみつからない。
https://www.scadacore.com/tools/programming-calculators/online-hex-converter/
https://binary-system.base-conversion.ro/convert-from-32bit-single-precision-IEEE754-binary-floating-point-to-real-numbers-float.php
これが非常に見づらく、使いづらいことよ。とほほ。
仕方ないので、整数の変換ツールと浮動小数点の変換ツールで、別々のものを使っている。
