  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        @types/react-router v5.1.9 
        react-router の型定義は受け取るパスが全て文字列のため、
        以前は TS コンパイラでパスの間違いを検出できませんでした。
        そのため僕は typed-path-builder というライブラリを作って次の記事を書きました。
        https://zenn.dev/stin/articles/introduce-typed-path-builder
        typed-path-builder は TypeScript の template literal types を駆使していますが、 
        @types/react-router v5.1.9 もそれを利用してパスパラメータを推論するように変更が加えられていました。
       ...
       <p className={styles.text}>
        ...
        https://zenn.dev/stin/articles/introduce-typed-path-builder
        typed-path-builder は 
        TypeScript の template literal types を駆使していますが、 
         @types/react-router v5.1.9 もそれを利用してパスパラメータを推論するように変更が加えられていました。<br></br>
        業務で v4 系を使っていて更新していなかったためこの変更にまったく気づいていませんでした。「いつの間に…！」と思って DefinitedlyTyped のプルリクエストを探してみたら、なんと 2020 年 12 月 28 日 にマージされています。
       </p>
